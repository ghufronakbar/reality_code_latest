    ...
    <footer className="bg-muted py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="font-medium text-sm mb-4 uppercase tracking-wider">Products</h4>
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/categories/productivity" className="text-muted-foreground hover:text-foreground">
                  Productivity
                </Link>
              </li>
              <li>
